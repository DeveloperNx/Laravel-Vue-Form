  		...
  		<div class="card-body">
  			<div class="container">
  				<div class="row">
  					...
  					<div class="col-lg-8">
  						<input type="text" placeholder="Enter Your First Name" name="firstname" class="form-control"  v-model.trim="$v.Details.firstname.$model"/>
  				...
  				<div class="row">
  					...
  					<div class="col-lg-8">
  						<input type="text" placeholder="Enter Your Last Name" name="lastname" class="form-control" v-model.trim="$v.Details.lastname.$model"  />
  				...
  				<div class="row">
  					...
  					<div class="col-lg-8">
  						<textarea  type="text" placeholder="Enter Your Address" name="address" class="form-control" v-model.trim="$v.Details.address.$model"></textarea>
  				...
  				<div class="row">
  					...
  					<div class="col-lg-8">
  						<input type="text" placeholder="Enter Your Contact Number" name="contactnumber" class="form-control" v-model.trim="$v.Details.contactnumber.$model" maxlength="10" />
  				...
  				<div class="row">
  					...
  					<div class="col-lg-8">
  						<input type="text" placeholder="Enter Your Email Id" name="email" class="form-control" v-model.trim="$v.Details.email.$model"/>
  				...
  				<div class="row">
  					...
  					<div class="col-lg-8">
  						 <input type="radio" name="gender" id="radbtn1" value="female" v-model.trim="$v.Details.gender.$model">
         				 <label for="radbtn1">Female</label>
         				 <br>
         				  <input type="radio" name="gender" id="radbtn2" value="male" v-model.trim="$v.Details.gender.$model">
  				...
  				<div class="row btn-submit">
  					<div class="col-lg-12">
  						<button class="btn btn-primary submit" @click.prevent="send">Submit</button>
  					</div>
  				</div>  
  			</div>
  	</div>
